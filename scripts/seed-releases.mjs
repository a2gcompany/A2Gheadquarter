...
const SUPABASE_URL = 'https://mrvhvbrcxlxywtwtxzhx.supabase.co'
const SUPABASE_SERVICE_KEY = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1ydmh2YnJjeGx4eXd0d3R4emh4Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2MjQ3NzQ1NywiZXhwIjoyMDc4MDUzNDU3fQ.YGV-1Og3bKlrnYA5dXCH5LBrBljZ5vNox5iHjC0D9mA'

...
// Google Sheets IDs
const RELEASES_SHEET_ID = "1bzMHgX-XgxxhPcEjx0IRL2FJ3TiZIuP09qSYQ9QAu_A"
const PITCHINGS_SHEET_ID = "1IY8tLs9rMwmmgAohlOV4h7djpmYSIZ-3R1e67Q0uyiU"
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const [releasesCSV, pitchingsCSV] = await Promise.all([
      fetchSheet(RELEASES_SHEET_ID),
      fetchSheet(PITCHINGS_SHEET_ID),
    ])
